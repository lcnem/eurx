...
func RandomizedGenState(simState *module.SimulationState) {
	...
	// hacky way to give accounts coins so they can create cdps (coins  includes eurx so it's possible to have sufficient balance to close a cdp)
	...
	for _, acc := range authGenesis.Accounts {
		...
		coinsToAdd := sdk.NewCoins(
			...
			sdk.NewCoin("eurx", sdk.NewInt(int64(simState.Rand.Intn(1000000000)))),
				...
				CollateralParams: types.CollateralParams{
					{
						...
						DebtLimit:           sdk.NewInt64Coin("eurx", 20000000000000),
					...
					},
					{
						...
						DebtLimit:           sdk.NewInt64Coin("eurx", 30000000000000),
				...
				CollateralParams: types.CollateralParams{
					{
						Denom:               "bnb",
						LiquidationRatio:    sdk.MustNewDecFromStr("1.5"),
						DebtLimit:           sdk.NewInt64Coin("eurx", 100000000000000),
						StabilityFee:        sdk.MustNewDecFromStr("1.000000002293273137"),
						LiquidationPenalty:  sdk.MustNewDecFromStr("0.075"),
