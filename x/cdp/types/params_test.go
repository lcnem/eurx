...
func (suite *ParamsTestSuite) TestParamValidation() {
	...
	testCases := []struct {
		...
		},
		{
			...
			args: args{
				globalDebtLimit: sdk.NewInt64Coin("eurx", 4000000000000),
				collateralParams: types.CollateralParams{
					{
						Denom:               "bnb",
						LiquidationRatio:    sdk.MustNewDecFromStr("1.5"),
						DebtLimit:           sdk.NewInt64Coin("eurx", 2000000000000),
		...
		},
		{
			...
			args: args{
				globalDebtLimit: sdk.NewInt64Coin("eurx", 2000000000000),
				collateralParams: types.CollateralParams{
					{
						Denom:               "bnb",
						LiquidationRatio:    sdk.MustNewDecFromStr("1.5"),
			...
			args: args{
				...
				collateralParams: types.CollateralParams{
					...
					},
					{
						Denom:               "xrp",
						LiquidationRatio:    sdk.MustNewDecFromStr("1.5"),
						DebtLimit:           sdk.NewInt64Coin("seur", 2000000000000),
						StabilityFee:        sdk.MustNewDecFromStr("1.000000001547125958"),
						LiquidationPenalty:  sdk.MustNewDecFromStr("0.05"),
						AuctionSize:         sdk.NewInt(50000000000),
						Prefix:              0x21,
