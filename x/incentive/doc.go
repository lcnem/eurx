...
on-chain incentives for users who open cdps and mint stablecoins (EURX).
...
will distribute 1000 KAVA each week (Duration) to users who mint EURX using collateral bnb.
...
minted 10% of all EURX backed by bnb for the entire reward period, they will be eligible to claim 10%
...
will claim all outstanding rewards for minting EURX backed by bnb for the input user.
