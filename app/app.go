...
import (
	...
	auctionkeeper "github.com/lcnem/eurx/x/auction/keeper"
	auctiontypes "github.com/lcnem/eurx/x/auction/types"
	"github.com/lcnem/eurx/x/cdp"
	cdpkeeper "github.com/lcnem/eurx/x/cdp/keeper"
	cdptypes "github.com/lcnem/eurx/x/cdp/types"
	"github.com/lcnem/eurx/x/estmdist"
	estmdistkeeper "github.com/lcnem/eurx/x/estmdist/keeper"
	estmdisttypes "github.com/lcnem/eurx/x/estmdist/types"
	"github.com/lcnem/eurx/x/incentive"
	incentivekeeper "github.com/lcnem/eurx/x/incentive/keeper"
	incentivetypes "github.com/lcnem/eurx/x/incentive/types"
	"github.com/lcnem/eurx/x/pricefeed"
	pricefeedkeeper "github.com/lcnem/eurx/x/pricefeed/keeper"
...
var (
	...
	maccPerms = map[string][]string{
		...
		estmdisttypes.ModuleName:       {authtypes.Minter},
	}
...
type App struct {
	*baseapp.BaseApp
	...
	estmdistKeeper  estmdistkeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		estmdisttypes.StoreKey, pricefeedtypes.StoreKey,
	)
	...
	app.estmdistKeeper = estmdistkeeper.NewKeeper(
		appCodec,
		keys[estmdisttypes.StoreKey],
		keys[estmdisttypes.MemStoreKey],
	...
	app.mm = module.NewManager(
		...
		estmdist.NewAppModule(appCodec, app.estmdistKeeper, app.AccountKeeper, app.BankKeeper),
	...
	app.mm.SetOrderBeginBlockers(
		...
		estmdisttypes.ModuleName, auctiontypes.ModuleName, cdptypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryMarshaler, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(estmdisttypes.ModuleName)
