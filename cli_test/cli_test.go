...
func TestKvCLIKeysAddRecover(t *testing.T) {
	...
	require.Equal(t, "eurx1rsjxn2e4dfl3a2qzuzzjvvgjmmate383g9q4cz", f.KeyAddress("test-recover").String())
	...
	require.True(t, exitSuccess)
	require.Equal(t, "eurx1qcfdf69js922qrdr4yaww3ax7gjml6pd39p8lj", f.KeyAddress("test-recover-legacy").String())
...
func TestStakeCLIKeysAddRecoverHDPath(t *testing.T) {
	...
	require.Equal(t, "eurx1rsjxn2e4dfl3a2qzuzzjvvgjmmate383g9q4cz", f.KeyAddress("test-recoverHD1").String())
	...
	require.Equal(t, "eurx1qpj6nstqn0n5gzcsaezspuhulje6msjq5t8cq5", f.KeyAddress("test-recoverH2").String())
	...
	require.Equal(t, "eurx1vayfpstgapt7dmv7074kc3ll8xpf0rlzvh4k08", f.KeyAddress("test-recoverH3").String())
	...
	require.Equal(t, "eurx1xvsfnksmhr887skcfrm4pe3va54tkmrtw7wyer", f.KeyAddress("test-recoverH4").String())
	...
	require.Equal(t, "eurx1v9plmhvyhgxk3th9ydacm7j4z357s3nhhmy0tv", f.KeyAddress("test-recoverH5").String())
	...
	require.True(t, exitSuccess)
	require.Equal(t, "eurx1rsjxn2e4dfl3a2qzuzzjvvgjmmate383g9q4cz", f.KeyAddress("test-recoverH6").String())
	...
	require.True(t, exitSuccess)
	require.Equal(t, "eurx1xvsfnksmhr887skcfrm4pe3va54tkmrtw7wyer", f.KeyAddress("test-recoverH7").String())
