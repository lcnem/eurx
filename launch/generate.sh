...
jq ".app_state.cdp.params.collateral_params += [{\"auction_size\":\"50000000000\",\"conversion_factor\":\"8\",\"debt_limit\":{\"amount\":\"2000000000000\",\"denom\":\"eurx\"},\"denom\":\"bnb\",\"liquidation_penalty\":\"0.05\",\"liquidation_ratio\":\"1.5\",\"spot_market_id\":\"bnb:jpy\",\"liquidation_market_id\":\"bnb:jpy:30\",\"prefix\":1,\"stability_fee\":\"1.0000000007829977\"}]" $GENESIS_FILE_NAME > $GENESIS_TMP_FILE_NAME && mv $GENESIS_TMP_FILE_NAME $GENESIS_FILE_NAME
